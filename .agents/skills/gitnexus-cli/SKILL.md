---
name: gitnexus-cli
description: "Úsalo cuando se necesite ejecutar comandos CLI de GitNexus como indexar/analizar el repositorio, comprobar estado, limpiar índice o generar una wiki. Ejemplos: 'Indexa este repo', 'Reanaliza el código', 'Genera una wiki'"
---

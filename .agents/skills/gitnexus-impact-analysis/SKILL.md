...
description: "Úsalo cuando se quiera saber qué se romperá si se modifica algo, o se necesite un análisis de seguridad e impacto antes de editar código. Ejemplos: '¿Es seguro cambiar X?', '¿Qué depende de esto?', '¿Qué romperá?'"
---

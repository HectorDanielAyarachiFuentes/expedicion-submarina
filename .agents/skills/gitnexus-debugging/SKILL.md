...
description: "Úsalo cuando se esté depurando un error, rastreando un fallo o preguntando por qué falla algo. Ejemplos: '¿Por qué falla X?', '¿De dónde viene este error?', 'Rastrea este bug'"
---

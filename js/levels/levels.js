...
export function initLevel(nivel) {
    ...
    console.log(`[Levels.js] Intentando iniciar Nivel ${nivel}. Modulo: ${activeLevelModule ? 'OK' : 'null'}, tiene init: ${Boolean(activeLevelModule && typeof activeLevelModule.init === 'function')}`);
